$(document).ready(function () {
    ...
    $(create_btn).click(function (a) {
        ...
        var prep = document.getElementById("create_recipeprep").value;
        var cook = document.getElementById("create_recipecook").value;
        var ready = document.getElementById("create_recipeready").value;
        if (title == "") {
    ...
    $(update_btn).click(function (p) {
        ...
        var prep = document.getElementById("update_recipeprep").value;
        var cook = document.getElementById("update_recipecook").value;
        var ready = document.getElementById("update_recipeready").value;
        if (title == "") {
            alert('Title must not be null');
            return;
        }
        ...
        var data = {
            ...
            update_recipePrep: prep,
            update_recipeCook: cook,
            update_recipeReady: ready,
